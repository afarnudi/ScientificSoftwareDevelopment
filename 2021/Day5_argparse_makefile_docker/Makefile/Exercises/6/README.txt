...
6 - Setup the makefile so that it will not delete your intermediate files.

7 - Setup the dependancies such that the paper is built whenever the following files are modified:
pipeline.tex
foo.png
foo.data
foo#.rawdata
